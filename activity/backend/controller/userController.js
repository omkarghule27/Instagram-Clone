...
function createUserPromisified(userObject) {
  return new Promise(function (resolve, reject) {
    ...
    if (isPublic != undefined) {
      sql = `INSERT INTO user_table(uid , name , email , password , pimage , username , bio , isPublic) VALUES ( '${uid}' , '${name}' , '${email}' , '${pw}' , '${pimage ? pimage : "default.png"}' , '${username}' , '${bio}' , ${isPublic})`;
    } else {
      sql = `INSERT INTO user_table(uid , name , email , password , username , bio ) VALUES ( '${uid}' , '${name}' , '${email}' , '${pw}' , '${pimage ? pimage : "default.png"}' , '${username}' , '${bio}')`;
    }
    console.log(sql);
    connection.query(sql, function (error, data) {
      if (error) {
